# Generated by Django 2.2.4 on 2019-08-06 09:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('drug_id', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='agmp_app.drug')),
                ('gene_id', models.ForeignKey(default=2, on_delete=django.db.models.deletion.CASCADE, to='agmp_app.pharmacogenes')),
            ],
        ),
        migrations.CreateModel(
            name='star_allele',
